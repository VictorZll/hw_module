!function (t, e) {
    ...
    return function (t) {
        ...
        !function (t) {
            ...
            function b(l) {
                if (l.target.classList.contains("jsn-es-draggable")) v = t(l.target); else {
                    var d = function (t) {
                        var e = t.parentNode, i = null;
        ...
        var r = {
            ...
            if ("next" === e) {
                ...
                for (var w = 0; w < u; w++) {
                    var $ = x + (d + p) * w;
                    v.includes((o + w) % n) || S.push({index: o + w, readyX: $}), m.push({
                        index: o + w,
                        newX: $ - (p + d) * g
                    })
                }
                ...
                for (var C = 0; C < u; C++) {
                    var P = k - (d + p) * (u - C - 1);
                    v.includes((o + C) % n) || S.push({index: o + C, readyX: P}), m.push({
                        index: o + C,
                        newX: P + (p + d) * g
                    })
                }
            ...
            for (var D = 0; D < u; D++) {
                var T = t.$slider.children().eq((h + D) % n).position().left, M = void 0;
            ...
            var e = t.opts, i = e.gutter, n = e.slidesToShow;
        ...
        var d = function () {
            ...
            return function (t, e, i) {
                ...
                key: "observe", value: function (t, e) {
                    if ("function" != typeof e) throw"Callback must be a function";
                    var i = t.getBoundingClientRect();
                    this.elems.set(t, {rect: i, callback: e})
                }
            }, {
        ...
        var u = window.jQuery, f = r.wrapper, p = r.inner, v = r.slide, y = r.indicators, g = r.controller,
            S = r.nextCtrl, m = r.prevCtrl, b = r.disabledCtrl, x = r.turnOffMouseEvent, w = function () {
                function t(e, i) {
                    !function (t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                ...
                return function (t, e, i) {
                    ...
                    key: "getWrapperWidthThenInit", value: function () {
                        var t, e = this, i = this.$el, n = i.css("background-image").slice(4, -1).replace(/"/g, ""),
                            s = new Image;
                    ...
                    key: "setupSliderDOM", value: function () {
                        ...
                        var l = e.css("background-image").slice(4, -1).replace(/"/g, ""), d = function i() {
                    ...
                    key: "handleResize", value: function (t) {
                        var e = this.opts, i = e.curr, n = e.slidesToShow, s = e.gutter, r = this.totalSlide,
                            o = this.sliderWidth;
                        r *= 3;
                        var l = a(this), d = this.$slider.children();
                        d.css({width: "".concat(l, "px"), transition: ""});
                        for (var c = 0; c < r; c++) {
                            var h = d.eq(c);
                            c >= i && c < i + n ? h.css({transform: "translate3d(".concat((l + s) * (c - i), "px, 0, 0)")}) : h.css({transform: "translate3d(".concat(o + s, "px, 0, 0)")})
                        }
                    }
                }, {
                    ...
                    key: "handleStyleChange", value: function () {
                        var t = this.$el.width();
                        this.sliderWidth = t, this.handleResize()
                    }
                }, {
                    key: "handleDragMove", value: function (e, i) {
                        var n = this;
                        if (!(Math.abs(i.moveX) < t.constructor.MIN_DRAG_DISTANCE)) {
                            this.clearAutoPlay();
                            var s = i.moveX, r = this.opts, l = r.curr, d = r.slidesToShow, c = r.gutter, h = r.loop,
                                u = (l + d) % (3 * this.totalSlide), f = o(this, "next", u).nextSlidesReadyPos;
                            ...
                            if (h || (S = S.filter(function (t) {
                                ...
                                var m = !0, b = !1, x = void 0;
                                try {
                                    for (var w, $ = S[Symbol.iterator](); !(m = (w = $.next()).done); m = !0) {
                                        var O = w.value, k = this.$slider.children().eq(O.index);
                                ...
                                for (var C = 0; C < p.length; C++) {
                                    var P = p[C], D = this.$slider.children().eq(P.index);
                                    this.translateSlide(D, P.readyX + s)
                                }
                                var T = !0, M = !1, j = void 0;
                                try {
                                    for (var X, A = f[Symbol.iterator](); !(T = (X = A.next()).done); T = !0) {
                                        var q = X.value, E = this.$slider.children().eq(q.index);
                    ...
                    key: "handleDragStop", value: function (e, i) {
                        if (!(Math.abs(i.moveX) < t.constructor.MIN_DRAG_DISTANCE)) {
                            this.moveByDrag = !0;
                            var n, s = i.velocityX, r = i.moveX / this.sliderWidth, o = "", a = this.totalSlide,
                                l = this.opts, d = l.loop, c = l.curr, h = l.slidesToShow, u = l.duration,
                                f = Math.abs(r) * u;
                            if (s > 1 || Math.abs(r) > .3) {
                                if (!d) {
                    ...
                    key: "verifyOptions", value: function () {
                        ...
                        var n = this.constructor.styleOptions.paginations, s = this.constructor.styleOptions.navs;
                    ...
                    key: "updateOptions", value: function (t) {
                        var e = this.constructor.defaultOptions, i = this.constructor.styleOptions.paginations,
                            n = this.opts.paginationStyle, s = this.constructor.styleOptions.navs, r = this.opts.navStyle;
                        for (var o in t) if (c(t[o]) === c(e[o]) && "curr" !== o) {
                            var a = t[o];
                    ...
                    key: "clearAutoPlay", value: function () {
                    ...
                    key: "moveSlide", value: function (t, e, i) {
                        var n = this;
                        this.clearAutoPlay();
                        var s = this.opts, r = s.curr, a = s.slidesToShow;
                        if (s.loop || this.moveByDrag || !("prev" === t && 0 === r || "next" === t && r + a - 1 >= this.totalSlide - 1 || "next" === t && e + a - 1 > this.totalSlide - 1)) {
                            this.$el.addClass(x);
                            var l = o(this, t, e), d = l.nextIndex, c = l.nextSlidesReadyPos, h = l.currSlidesNewPos,
                                u = l.nextSlidesNewPos;
                            if (!this.moveByDrag) {
                                var f = !0, p = !1, v = void 0;
                                try {
                                    for (var y, g = c[Symbol.iterator](); !(f = (y = g.next()).done); f = !0) {
                                        var S = y.value, m = this.$slider.children().eq(S.index);
                            ...
                            setTimeout(function () {
                                if (!n.missingSlidesOnDrag) {
                                    ...
                                    try {
                                        for (var s, r = h[Symbol.iterator](); !(t = (s = r.next()).done); t = !0) {
                                            var o = s.value, a = n.$slider.children().eq(o.index);
                                ...
                                var l = !0, d = !1, c = void 0;
                                try {
                                    for (var f, p = u[Symbol.iterator](); !(l = (f = p.next()).done); l = !0) {
                                        var v = f.value, y = n.$slider.children().eq(v.index);
                    ...
                    key: "translateSlide", value: function (t, e, i) {
                        i ? t.css({transition: "transform ".concat(i, "ms linear")}) : t.css({transition: ""}), t.css("transform", "translate3d(".concat(e, "px, 0, 0)"))
                    }
                }, {
                    key: "next", value: function () {
                        var t = this.opts, e = t.curr, i = t.loop, n = t.slidesToScroll, s = t.slidesToShow,
                            r = this.totalSlide;
                        i ? this.moveSlide("next") : e + n + s >= r ? this.goto(r - s) : this.moveSlide("next")
                    }
                }, {
                    key: "prev", value: function () {
                        var t = this.opts, e = t.curr, i = t.loop, n = t.slidesToScroll;
                        i ? this.moveSlide("prev") : e - n <= 0 ? this.goto(0) : this.moveSlide("prev")
                    }
                }, {
                    key: "goto", value: function (t) {
                        var e = this.opts, i = e.curr, n = e.loop, s = e.slidesToShow, r = this.totalSlide;
                        if (t > i) {
                    ...
                    key: "updateSliderStyle", value: function () {
                        var t = this.$slider.children(), e = t.eq(this.opts.curr), i = a(this), n = this.opts,
                            s = n.adaptiveHeight;
                        n.height;
                        s ? (t.css({height: ""}), this.$el.css("transition", "height ".concat(this.opts.duration, "ms ease-in-out")), this.$slider.css("transition", "height ".concat(this.opts.duration, "ms ease-in-out")), this.$el.css("height", ""), this.$slider.css("height", "".concat(e.height(), "px"))) : (t.css({
                            height: "100%",
                            width: "".concat(i, "px")
                        }), this.$slider.css({
                            height: "100%",
                            transition: ""
                        }), this.$el.css({transition: ""})), t.addClass(v);
                        for (var r = this.opts.gutter, o = 0; o < t.length; o++) {
                            var l = o * (i + r);
                            t.eq(o).css({transform: "translate3d(".concat(l, "px, 0, 0)")})
                        }
                        ...
                        var d = this.opts.navStyle, c = this.opts.paginationStyle;
                    ...
                    key: "updateSliderCtrlStyle", value: function (t) {
                    ...
                    key: "udpateActiveSlideStyle", value: function () {
                        var t = this.opts, e = t.curr, i = t.slidesToShow, n = t.loop;
